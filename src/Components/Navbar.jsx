            ...
            <div className="container-fluid fixed-top">
                <div className="container topbar bg-primary d-none d-lg-block">
                    <div className="d-flex justify-content-between top-info ps-2">
                        ...
                        <small><i className="fa fa-envelope me-2 text-light"></i><a target='_blank' rel="noreferrer" href="mailto:anujkshah2@gmail.com" className="text-white">anujkshah2@gmail.com</a></small>
                        <small><i className="fa fa-phone me-2 text-light"></i><a target='_blank' rel="noreferrer" href="tel:9873848046" className="text-white">+91-8368864957</a></small>
                        <small><i className="fab fa-whatsapp me-2 text-light"></i><a target='_blank' rel="noreferrer" href="https://wa.me/8368864957" className="text-white">+91-8368864957</a></small>
                    </div>
                </div>
